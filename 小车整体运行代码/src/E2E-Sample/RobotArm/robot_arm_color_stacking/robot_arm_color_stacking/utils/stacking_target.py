...
class stacking_GetTarget:
    def __init__(self, test_mode=False):
        ...
        FILE = Path(__file__).resolve() # /home/HwHiAiUser/E2ESamples/ros2_dofbot_formal_ws/install/robot_arm_color_stacking/lib/python3.10/site-packages/robot_arm_color_stacking/utils/stacking_target.py
        ...
        # for testing
        # model_path = "/home/HwHiAiUser/E2ESamples/ros2_dofbot_formal_ws/src/robot_arm_color_stacking/robot_arm_color_stacking/model/yolov5s_bs1.om"
        # label_path = "/home/HwHiAiUser/E2ESamples/ros2_dofbot_formal_ws/src/robot_arm_color_stacking/robot_arm_color_stacking/model/coco_names.txt"
        # cfg_folder = "/home/HwHiAiUser/E2ESamples/ros2_dofbot_formal_ws/src/robot_arm_color_stacking/robot_arm_color_stacking/config"
    ...
    def select_color(self, image, color_hsv, color_list, garbage_index=0):
        '''
        选择识别颜色
        :param image:输入图像
