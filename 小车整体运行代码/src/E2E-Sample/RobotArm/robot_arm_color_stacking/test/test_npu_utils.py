...
import cv2
import torch
from robot_arm_color_stacking.utils.npu_utils import preprocess_image, draw_bbox, get_labels_from_txt, draw_prediction, infer_image, xyxy2xywh
...
class TestNPUUtils:
    ...
    def test_infer_image(self):
        pred_all, class_names, drawed_res = infer_image(self.img_bgr, self.model, self.labels_dict, self.cfg)
