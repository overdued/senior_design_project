# RosImgCallback<a name="ZH-CN_TOPIC_0000001539344456"></a>

## 函数功能<a name="section15868409121"></a>

派生类NNObjectDetectNode中实现ROS2话题订阅的回调函数，用于处理一帧图像数据。
...
**void RosImgCallback\(const sensor\_msgs::msg::Image::ConstSharedPtr msg\)**
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="29.03%" headers="mcps1.1.4.1.1 "><p id="li67795692518p0"><a name="li67795692518p0"></a><a name="li67795692518p0"></a>msg</p>
</td>
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p178118113332"><a name="p178118113332"></a><a name="p178118113332"></a>ROS2格式消息，类型是const sensor_msgs::msg::Image::ConstSharedPtr。</p>
</td>
</tr>
</tbody>
</table>
