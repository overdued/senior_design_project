# CreateInput<a name="ZH-CN_TOPIC_0000001539184476"></a>

## 函数功能<a name="section15868409121"></a>

AscendCL接口实现类AclInterfaceImpl中创建模型输入的函数。
...
**Result CreateInput\(std::vector<DataInfo\> inputs\)**
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0122830089_p19388143103518"><a name="zh-cn_topic_0122830089_p19388143103518"></a><a name="zh-cn_topic_0122830089_p19388143103518"></a>模型输入需要的数据，类型是std::vector&lt;DataInfo&gt;。</p>
</td>
</tr>
</tbody>
</table>
