...
# ========== 配置路径 ==========
OPENNI2_LIB_PATH = "/root/UART_com/camera_location/yolov5_d435i_detection-main/OpenNI_2.3.0.86_202210111155_4c8f5aa4_beta6_a311d/sdk/libs"  # 改为你的路径
...
try:
    while True:
        ...
        # 目标检测
        img_tensor, canvas = preprocess(color_data)
        t1 = time_sync()
