...
IMPLEMT_VERIFIER(ScatterNdAddTik, ScatterNdAddTikVerify) {
...
IMPLEMT_COMMON_INFERFUNC(ScatterNdAddTikInferShape) {
...
COMMON_INFER_FUNC_REG(ScatterNdAddTik, ScatterNdAddTikInferShape);
VERIFY_FUNC_REG(ScatterNdAddTik, ScatterNdAddTikVerify);
}
