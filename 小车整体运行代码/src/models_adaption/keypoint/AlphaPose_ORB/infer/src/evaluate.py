...
def main():
    ...
    image_dir = os.path.join(image_dir, sys.argv[1])
    image_folder = os.path.join(image_dir, "val2017")
    annotation_file = os.path.join(image_dir, "annotations/person_keypoints_val2017.json")
