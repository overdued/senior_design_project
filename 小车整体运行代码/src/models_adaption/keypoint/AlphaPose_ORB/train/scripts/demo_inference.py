...
from trackers_files.tracker_api import Tracker
from trackers_files.tracker_cfg import cfg as tcfg
from trackers_files import track
...
"""----------------------------- Demo_V1 options -----------------------------"""
parser = argparse.ArgumentParser(description='AlphaPose Demo_V1')
...
def main():
    if not os.path.isfile(args.checkpoint):
        return 'ERROR: not found checkpoint file.'
    if not os.path.exists(args.cfg):
        return 'ERROR: not found data.yaml file.'
