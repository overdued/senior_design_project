...
sys.path.append('../')
from yolov5.train_code.utils.google_utils import gsutil_getsize
from yolov5.train_code.utils.torch_utils import init_torch_seeds
...
def non_max_suppression(prediction, conf_thres=0.3, iou_thres=0.25, classes=None, agnostic=False, labels=(), names=[]):
    ...
    multi_label = (len(names) != 1)  # multiple labels per box (adds 0.5ms/img)
