...
def detect(opt, save_img=False):
    ...
    if os.path.exists(out):
        raise Exception("output path already exists.")  # delete output folder
...
def main():
    ...
    parser.add_argument('--conf_thres', type=str, default="0.4", help='object confidence threshold')
    ...
    print(opt)
    opt.conf_thres = float(opt.conf_thres)
    ...
    if opt.conf_thres <= 0 or opt.conf_thres > 1:
        return 'ERROR: conf_thres out of range (0, 1].'
