...
import test_prune  # import test.py to get mAP after each epoch
from utils.datasets import create_dataloader
from utils.general import (
    check_img_size, labels_to_class_weights, plot_labels,
...
from utils.torch_utils import init_torch_seeds, ModelEMA, select_device, initialize_weights
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if not opt.notest or final_epoch:  # Calculate mAP
                results, maps, times = test_prune.test_cfg(opt.data,
