...
class labelme2coco(object):
    def __init__(self, input_path, labelme_json=[], save_json_path='./tran.json'):
    ...
    def image(self, data, num):
        ...
        img = cv2.imread(self.input_path + os.sep + data['imagePath'], 0)
...
def Change2Coco(input_path, output_path, split_ratio, split_test):
    ...
    labelme2coco(input_path, train_jsons, os.path.join(train_label,'train_annotation.json'))

    labelme2coco(input_path, val_jsons, os.path.join(val_label,'val_annotation.json'))

    if split_test:
        labelme2coco(input_path, test_jsons,os.path.join(test_label,'test_annotation.json'))
...
if __name__ == "__main__":
    ...
    # # 开放参数
    # parser.add_argument('--input_path', default='sample_data', type=str)
    # parser.add_argument('--output_path', default='yolact_edge/data/coco_small_data', type=str)
    # parser.add_argument('--split_ratio', default=0.3, type=float)
    # parser.add_argument('--split_test', default="False", type=str)
    ...
    try:
        ret = Change2Coco(input_path, trans_output_path, split_ratio, split_test)
