...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': 'data/coco_small_data/train/images',
    'train_info':   'data/coco_small_data/train/train_annotation.json',

    'valid_images': 'data/coco_small_data/valid/images',
    'valid_info':   'data/coco_small_data/valid/val_annotation.json',

    'has_gt': True,
    'class_names': ('person', 'car', 'bear'),
})
