...
my_custom_dataset = dataset_base.copy({ # 可调参,用自己数据集时必须修改
    'name': 'My Dataset',

    # Training images and annotations
    'train_images': 'data/coco_format_data/train/images',
    'train_info':   'data/coco_format_data/train/train_annotation.json',

    # Validation images and annotations.
    'valid_images': 'data/coco_format_data/valid/images',
    'valid_info':   'data/coco_format_data/valid/val_annotation.json',
...
# Default config
cfg = yolact_base_config.copy({ # 可调参
    'name': 'yolact_base_transfer',
