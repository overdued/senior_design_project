...
from src.labelme.labelme.convert_model.segmentation.convert_thread import ConvertThread
from src.labelme.labelme.run_cmd_utils import is_contains_chinese, check_path
from src.labelme.labelme.convert_model.segmentation.component.segmentation import Ui_frame_body
...
class ConvertModel(QWidget, Ui_frame_body):
    ...
    def __init__(self, model_no):
        ...
        self.translate()
        self.setWindowTitle(self.tr("Segmentation"))
    ...
    def translate(self):
        self.label_title.setText(self.tr("Segmentation"))
