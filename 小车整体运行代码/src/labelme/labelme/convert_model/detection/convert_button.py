...
from src.labelme.labelme.convert_model.detection.convert_thread import ConvertThread
from src.labelme.labelme.run_cmd_utils import is_contains_chinese, check_path
from src.labelme.labelme.convert_model.detection.component.detection import Ui_frame_body
...
class ConvertModel(QWidget, Ui_frame_body):
    ...
    def __init__(self, model_no):
        ...
        self.translate()
        self.setWindowTitle(self.tr("Detection"))
    ...
    def pkg_start(self):
        if self.start_button.text() == self.tr('Transfer'):
            ...
            self.pre_model_data = self.comboBox.currentText()
            ...
            if self.ds_data and self.ratio_data and self.epoch_data and self.batch_data and self.output_data:
                ...
                self.thread = ConvertThread(self.ds_data, self.ratio_data,
                                            int(self.epoch_data), int(self.batch_data),
                                            self.pre_model_data, self.output_data,
