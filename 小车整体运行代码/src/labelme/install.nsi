...
Name "${PRODUCT_NAME}"
OutFile "Ascend-devkit-model-adapter_${PRODUCT_VERSION}_win-x86_64.exe"
...
Function .onInit
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "Ascend-devkit-model-adapter_${PRODUCT_VERSION}_win-x86_64.exe") i .r1 ?e'
  Pop $R0
  StrCmp $R0 0 +3
  ...
  StrLen $1 $0
  IntCmp $1 0 +3 +1 +1
  MessageBox MB_OK|MB_USERICON|MB_TOPMOST '$(^Name) Installed on your computer. It needs to be reinstalled. Please uninstall the existing installation.'
  Quit
FunctionEnd
